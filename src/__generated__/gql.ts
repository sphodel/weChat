 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query Chat_Content($userId:Int!) {\n  chats(order_by: {time: desc}, limit: 1, where: {_or: [{to: {_eq: $userId}}, {from: {_eq:$userId}}]}) {\n    id\n    text\n    time\n  }\n}\n\n"): (typeof documents)["query Chat_Content($userId:Int!) {\n  chats(order_by: {time: desc}, limit: 1, where: {_or: [{to: {_eq: $userId}}, {from: {_eq:$userId}}]}) {\n    id\n    text\n    time\n  }\n}\n\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation Chat($from: Int!, $text: String!, $time: timestamp!, $to: Int!) {\n  insert_chats_one(object: {from: $from, text: $text, time: $time, to: $to}) {\n    text\n  }\n}\n"): (typeof documents)["mutation Chat($from: Int!, $text: String!, $time: timestamp!, $to: Int!) {\n  insert_chats_one(object: {from: $from, text: $text, time: $time, to: $to}) {\n    text\n  }\n}\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "subscription ChatContent($userId: Int!) {\n  chats(where: {_or: [{to: {_eq: $userId}}, {from: {_eq: $userId}}]}, order_by: {time: desc}) {\n    text\n    from\n  }\n}\n"): (typeof documents)["subscription ChatContent($userId: Int!) {\n  chats(where: {_or: [{to: {_eq: $userId}}, {from: {_eq: $userId}}]}, order_by: {time: desc}) {\n    text\n    from\n  }\n}\n"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query loginVer($id: Int!) {\n  users(where: {id: {_eq: $id}}) {\n    password\n  }\n}"): (typeof documents)["query loginVer($id: Int!) {\n  users(where: {id: {_eq: $id}}) {\n    password\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
