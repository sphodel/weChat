...
const NewReg = () => {
    ...
    return (
        <div className="flex flex-col items-center w-2/3 h-svh mt-10 m-auto">
            <div className="flex font-semibold h-14 items-center ">
                用手机号注册
            </div>
            <div className={"pb-5"}>
                <img src={"user_image.jpg"} className={"w-10 h-10"} alt={""}/>
            </div>
...
const NewRegContent = ({setMescontent}: { setMescontent: (v: string[]) => void }) => {
    ...
    return (
        <div className="h-40 flex-col box-border flex w-full">
            <div style={{borderTop: "1px solid #ddd", borderBottom: "1px solid #ddd"}}>
                <div className="flex  items-center py-2 gap-20">
                    <div>昵称</div>
            ...
            <div style={{borderBottom: "1px solid #ddd"}}>
                <div className="flex  items-center py-2">
                    ...
                    <input placeholder={"请填写手机号码"} className={"outline-0 w-32"} value={phonenum}
                           onChange={(e) => {
            ...
            <div style={{borderBottom: "1px solid #ddd"}}>
                <div className="flex  items-center py-2">
                    ...
                    <input placeholder={"请设置密码"} className={"outline-0 w-32"}
